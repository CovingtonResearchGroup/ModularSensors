 ...
 *
 * @brief Contains the SenseairK30 sensor subclass and the SenseairK30_CO2
 * variable subclass.
 *
 * These are for the Senseair K30 carbon dioxide sensor.
 */
/* clang-format off */
/**
 * @defgroup sensor_senseair MaxBotix MaxSonar
 * Classes for the Senseair K30 carbon dioxide sensor.
 *
 * @ingroup the_sensors
 *
 * @tableofcontents
...
// Header Guards
#ifndef SRC_SENSORS_SENSEAIRK30_H_
...
/** @ingroup sensor_senseair */
/**@{*/

// Sensor Specific Defines
/// @brief Sensor::_numReturnedValues; the K30 can report 1 value.
#define K30_NUM_VARIABLES 1
/// @brief Sensor::_incCalcValues; we don't calculate any additional values.
#define K30_INC_CALC_VARIABLES 0

/**
 * @anchor sensor_senseair_timing
 * @name Sensor Timing
 * The sensor timing for a Senseair K30 CO2 sensor
 */
/**@{*/
...
class SenseairK30 : public Sensor {
 public:
     ...
     * can be used.
     * @param powerPin The pin on the mcu controlling power to the K30.
     * Use -1 if it is continuously powered.
     * - The K30 requires a 5V - 14V power supply.
     * @param triggerPin The pin on the mcu controlling the "trigger" for the
     * K30.  Use -1 or omit for continuous ranging.
     ...
     *
     * For the K30, this also reads and dumps any returned "header" lines
     * from the sensor.
     *
 ...
 * [range output](@ref sensor_senseair_co2) from a
 * [Senseair K30 Carbon dioxide senser](@ref sensor_senseairK30).
 *
 * @ingroup sensor_senseair
 */
/* clang-format on */
class SenseairK30_CO2 : public Variable {
 public:
    /**
     * @brief Construct a new SenseairK30_CO2 object.
     *
     * @param parentSense The parent SenseairK30 providing the result
     * values.
     ...
     * @brief Construct a new SenseairK30_CO2 object.
     *
     * @note This must be tied with a parent SenseairK30 before it can be
     * used.
     */
    SenseairK30_CO2()
        : Variable((const uint8_t)K30_VAR_NUM, (uint8_t)K30_RESOLUTION,
                   K30_VAR_NAME, K30_UNIT_NAME, K30_DEFAULT_CODE) {}
    /**
     * @brief Destroy the SenseairK30_CO2 object - no action needed.
     */
    ~SenseairK30_CO2() {}
};
/**@}*/
#endif  // SRC_SENSORS_SENSEAIRK30_H_
